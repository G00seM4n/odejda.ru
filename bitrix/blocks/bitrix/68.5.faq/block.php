<section class="landing-block landing-block-faq-5 g-pa-30">
	<div class="container">
		...
		<div class="landing-block-card">
			<div class="landing-block-faq-visible g-cursor-pointer m-auto g-pa-30 g-pos-rel g-my-20 g-bg" style="--bg:#ffffff;">
				...
				<div class="landing-block-faq-icons">
					<i class="fas fa-chevron-down"></i>
					<i class="fas fa-times g-color-white"></i>
				</div>
				<p class="landing-block-faq-hidden g-mt-35 g-color" style="--color:hsla(0, 0%, 43%, 1);">
					Website builder.<br>
